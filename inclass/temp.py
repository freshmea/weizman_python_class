...
class Game:
    ...
    def load_data(self):
        ...
        # self.player_dinos = []
        # for x in range(1, 11):
        #     self.player_dinos.append(pygame.image.load(f'../png/Idle ({x}).png').convert_alpha())
        self.player_dinos = [pygame.image.load(f'../png/Idle ({x}).png').convert_alpha() for x in range(1, 10)]
